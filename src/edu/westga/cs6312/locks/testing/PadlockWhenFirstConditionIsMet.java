...
/**
 * This is a class to test the functionality of the Padlock isFirstConditionMet
 * method
 * 
...
class PadlockWhenFirstConditionIsMet {
	...
	/**
	 * Test to be sure that when the lock spins 42 ticks to the right the current
	 * value equals first combination number
	 */
	@Test
	public void testIsFirstConditionMetWith42() {
		Padlock simpleLock = new Padlock(8, 20, 15);
		simpleLock.spinRight(42);
		boolean results = simpleLock.isFirstConditionMet();
		assertEquals(true, results);
	}

	/**
	 * Test to be sure that when the lock spins 49 ticks to the right the current
	 * value equals first combination number
	 */
	@Test
	...
	/**
	 * Test to be sure that when the lock spins 55 ticks to the right the current
	 * value equals first combination number
	 */
	@Test
	...
	/**
	 * Test to be sure that when the lock spins 50 ticks to the right the current
	 * value will not equal first combination number
	 */
	@Test
